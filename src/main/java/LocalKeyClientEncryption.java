...
public class LocalKeyClientEncryption {
     ...
     */
    public static EncryptedBlobClient setup(String storageAccount, String sharedKeyCred, String containerName, String blobName,
     ...
     */
    public static void decryptReupload(EncryptedBlobClient encryptedBlobClient, String storageAccount, String sharedKeyCred, String containerName, String blobName,
                                String blobSuffix, CustomerProvidedKey serverKey) {
        String storageAccountUrl = "https://" + storageAccount + ".blob.core.windows.net";
    ...
    public static void main(String[] args) {
        ...
        EncryptedBlobClient blobClientEncrypted = setup(storageAccount, sharedKeyCred, containerName, blobName, blobSuffix, key);
